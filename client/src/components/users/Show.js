...
import { retrieve, reset } from '../../actions/users/show';
import { del } from '../../actions/users/delete';
          ...
          <table className="table table-responsive table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{this.renderLinks('roles', item['role'])}</td>
              </tr>
            </tbody>
          </table>
        )}
...
const mapStateToProps = state => ({
  ...
  eventSource: state.users.show.eventSource,
